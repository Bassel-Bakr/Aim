...
Every page in `docs/wiki/` carries this banner until you check it:
...
1. **Voltaic rank mechanics** — `docs/wiki/training/benchmarks.md`, `docs/wiki/resources/communities/voltaic.md`.
...
2. **Revosect details** — `docs/wiki/resources/communities/revosect.md`, `docs/wiki/training/benchmarks.md`.
   ...
   together.
3. **Season 5 scenario descriptions** — `docs/wiki/skills/clicking.md`, `tracking.md`, `switching.md`.
...
4. **Jade Palace** — `docs/wiki/resources/communities/jade-palace.md`. Public information is thin, and the
...
- `docs/wiki/getting-started/setup.md` — the Windows 10 route to "Enhance pointer precision" is written as
  Control Panel; Microsoft's page documents Settings › Devices › Mouse › Additional mouse options.
- `docs/wiki/fundamentals/practice-principles.md` — the Revosect variety advice cites a Google Doc URL.
  A `revosect.com/resources` link would be more stable.
- `docs/wiki/glossary.md` — the Underflick entry's wording sits close to its source's sentence. Reword it
  when you pass through.
- `docs/wiki/training/routines.md` and `docs/wiki/training/health.md` — the warm-up advice is explained twice.
...
1. Create the GitHub repository `bassel-bakr/aim`.
