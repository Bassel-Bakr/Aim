...
existing work (Voltaic, Jade Palace, Revosect, trainers, and creators) through dedicated resource pages.
...
Navigation follows a learner journey. About 30 pages.
...
- **Resources** — `resources/`
  ...
  - `creators/`: `corporate-serf.md`, `matty-ow.md`, `aimer-lew.md`, `viscose.md`
...
- Type: `community`, `trainer`, `creator`
