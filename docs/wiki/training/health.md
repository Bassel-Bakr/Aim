...
categories of strain that affect anyone who works at a screen and mouse for hours. None of what
follows is specific to aim training, it's general computer-ergonomics and rest advice from health
and ergonomics organizations, applied to a hobby built around a lot of small, repeated mouse
movement.
...
scaling training back and easing it up again, not abandoning it indefinitely.

**Sleep and rest days.** Sleep affects the same reaction-time and visual-processing systems that
aim training relies on: [Voltaic's own lifestyle guide](https://blog.voltaic.gg/lifestyle/) cites
research tying prolonged short sleep to reaction times comparable to mild alcohol impairment, and
recommends aiming for roughly 8 to 9 hours on a consistent schedule. Full rest days between hard
training blocks matter for the same reason a break inside a single session does: recovery is part
of how both the skill and the body actually adapt, not time taken away from training.

## Common mistakes

- Treating strain symptoms like tingling or numbness as something to train through instead of a
  signal to stop and rest.
- Skipping warm-up and breaks on the days you're pushing hardest, exactly when repetitive load is
  highest.
- Cutting sleep to fit in more practice time, which works against the same reaction time you're
  trying to train.
