...
does not require, rather than chasing every part of the target you could chase. Voltaic's Matty
defines it as a deliberate choice to "withhold extra motion on a target," made so the target is
easier to judge and the shot easier to time.[^matty]

## Explanation

**The economy argument.** Motion you add has to be watched, corrected, and timed around. Cutting
the movements a shot does not need leaves fewer of them competing for your attention, which is why
the technique is framed as making aim cleaner and more efficient rather than as making it slower.
...
so they are not interchangeable.[^matty]

**Not the same as underflicking.** An underflick is a fact about one flick: it stopped short of the
target, see [Glossary](../glossary.md). Underaiming is a decision taken before the movement, about
how much of it to commit at all, and it carries across every target you face rather than describing
a single one.[^matty]
...
not threaten the shot are precisely the overhead this technique removes, and they crowd the read
they were meant to support.[^matty]
