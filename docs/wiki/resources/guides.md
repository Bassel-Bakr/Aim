...
- [Wrist aiming vs arm aiming](https://aimlabs.com/articles/aimlabs/wrist-aiming-vs-arm-aiming-why-not-both/) —
  Aimlabs — which joint drives which movement.
...
- [Static aiming guide](https://www.youtube.com/watch?v=B0Y1KSYxuo4) — bardOZ, 2021 — Sixshot and
  1wall6targets small, by the player the Bardoz method is named for.
- [The best static dots tutorial in the world (probably not)](https://www.youtube.com/watch?v=CLpA6mXaCvw) —
  rensi, 2024 — static dots in two and a half minutes.
