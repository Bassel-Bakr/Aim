...
- **[Routines](../../training/routines.md)**: foundational Aimlabs routines plus weakness- and smoothness-specific routines. There are also separate game-specific practice routines and playlists, for titles including Valorant, Apex Legends, Overwatch 2, Call of Duty/Warzone, Battlefield, Counter-Strike 2, and Fortnite.[^res]
